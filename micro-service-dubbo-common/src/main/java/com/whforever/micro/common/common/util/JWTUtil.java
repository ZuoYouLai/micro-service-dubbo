...
import com.quarkdata.quark.share.model.common.Messages;
import com.quarkdata.quark.share.model.common.ResultCode;
...
public class JWTUtil {
    ...
    public static final String INC_ID = "incId";

    public static String JWT_ID = PropertiesUtils.prop.get("jwt.id");
    public static String JWT_SECRET = PropertiesUtils.prop.get("jwt.secret");
    public static Integer JWT_TTL = Integer.parseInt(PropertiesUtils.prop.get("jwt.ttl"));
    public static String JWT_SUBJECT = PropertiesUtils.prop.get("jwt.subject");
    public static String JWT_ISSUER = PropertiesUtils.prop.get("jwt.issuer");
     ...
     * @return
     */
    public static String createToken(long userId, long incId){
        Map<String, Object> map = new HashMap<>();
        map.put(USER_ID, userId);
        map.put(INC_ID, incId);
    ...
    public static ResultCode<Map<String, Long>> validateToken(String token){
        ...
        try {
            ...
            map.put(INC_ID,  Long.parseLong(claims.get(INC_ID)+""));
