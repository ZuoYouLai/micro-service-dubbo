...
public class DateUtil {
    ...
    public static Map getMondayCount(String from, String to, int day) {
        ...
        for (int i = 0; i < array.length; i++) {
            ...
            calendar.set(Integer.parseInt(fs[0]), Integer.parseInt(fs[1]) - 1,
     ...
     * @param format 日期格式 return yyyy-MM-dd
     */
    public static Date getMouthDate(int type) {
        ...
        try {
            ...
            if (type == 0) {
                ...
                return df.parse(format.format(ca.getTime()));
            }
     ...
     * 根据传入的数字返回周一或周日的日期
     * 
     * @param day1 获取周一:0; 周日:6; 上周一:-7; 上周日:-1; 下周一:7;下周日:13
     * @param format 日期格式 return yyyy-MM-dd
     * 
     */
    ...
    public static Date getMondayOfThisWeek() {
        Long millons = System.currentTimeMillis() / (1000 * 3600 * 24) * (1000 * 3600 * 24)
    ...
    public static Date getNextMonday() {
        ...
        long millions = cal.getTime().getTime() / (1000 * 3600 * 24) * (1000 * 3600 * 24)
                - TimeZone.getDefault().getRawOffset();
    ...
    public static Date getNextSunday() {
        ...
        long millions = cal.getTime().getTime() / (1000 * 3600 * 24) * (1000 * 3600 * 24)
                + 1000 * 3600 * 24 - TimeZone.getDefault().getRawOffset();
        Date rDate = new Date(millions);
        return rDate;
    }
    ...
    public static Date getSundayOfThisWeek() {
        ...
        Long millons = c.getTimeInMillis() / (1000 * 3600 * 24) * (1000 * 3600 * 24)
                - TimeZone.getDefault().getRawOffset() + 1000 * 3600 * 24;
        Date date = new Date(millons);
        return date;
    }
